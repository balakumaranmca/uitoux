...
import productRatingData from "../models/uitouxproductRating.model";
import {productReviewSchema, productUpdateSchema} from "../validations/product.validation";

export class ProductsData {
  uiTouXgetproductDetails  =   async (req:Request, res: Response) => {
    try {
  ...
  uiTouXaddProductReview  =   async (req:Request, res: Response) => {
    try {
      const tokenDetails = (req as any).decoded;
  ...
  uiTouXupdateProductOffer = async (req:Request, res: Response) => {
    try {
